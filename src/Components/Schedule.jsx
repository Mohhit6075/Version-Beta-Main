  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h1 className="w-full text-[#8198AF] text-3xl flex items-center justify-between"><span className="w-fit">Registration</span><div className="h-[1px] w-full bg-[#897be2] relative left-4"></div></h1>
        ...
        <h1 className="w-full text-[#8198AF] text-3xl flex items-center justify-between"><span className="w-fit">Ideation</span><div className="h-[1px] w-full bg-[#897be2] relative left-4"></div></h1>
          <p className="text-[#ccc] text-[13px] mt-4 font-normal">
        ...
        <h1 className="w-full text-[#8198AF] text-3xl flex items-center justify-between"><span className="w-fit">Annoucement</span><div className="h-[1px] w-full bg-[#897be2] relative left-4"></div></h1>
          <p className="text-[#ccc] text-[13px] mt-4 font-normal">
        ...
        <div className="absolute scale-90 md:scale-100 lg:scale-100 xl:scale-100 bottom-40 md:bottom-[256px] lg:bottom-[256px] xl:bottom-[256px] left-16 right-2 md:right-0 lg:right-0 xl:right-0 md:left-32 border border-[#897be2] rounded-lg lg:w-[80%] xl:w-[60%] w-fit p-4 py-6 hover:bg-[#1e1e20] hover:backdrop-blur-md hover:bg-opacity-30 transition-all duration-300">
        <h1 className="w-full text-[#8198AF] text-3xl flex items-center justify-between"><span className="w-fit">Team</span><div className="h-[1px] w-full bg-[#897be2] relative left-4"></div></h1>
          <p className="text-[#ccc] text-[13px] mt-4 font-normal">
        ...
        <div className="absolute scale-90 md:scale-100 lg:scale-100 xl:scale-100 -bottom-12 md:bottom-0 lg:bottom-0 xl:bottom-0 translate-y-2 left-16 right-2 md:right-0 lg:right-0 xl:right-0 md:left-32 border border-[#897be2] rounded-lg lg:w-[80%] xl:w-[60%] w-fit p-4 py-6 hover:bg-[#1e1e20] hover:backdrop-blur-md hover:bg-opacity-30 transition-all duration-300">
          <h1 className="w-full text-[#8198AF] text-3xl flex items-center justify-between"><span className="w-fit">Hackathon</span><div className="h-[1px] w-full bg-[#897be2] relative left-4"></div></h1>
          <p className="text-[#ccc] text-[13px] mt-4 font-normal">
